...
MRS uses two formats optimized for different purposes:

| Format | Purpose | Who Uses It |
|--------|---------|-------------|
| **MRS-S** | Storage, reading, archival | Orchestrator stores; agents read |
| **MRS-Ops** | Mutations, writing | Agents write; orchestrator applies |
