...
The Extract-Replace Protocol defines how the orchestrator creates Working Set Envelopes from canonical MRS-S and how agent operations (MRS-Ops) are validated and applied.
